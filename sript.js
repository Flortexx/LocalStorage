...
function sendMessage() {
    ...
    if (message.trim() !== "") {
        ...
        outputDiv.innerHTML += "<p id='" + messageId + "'>" + day + "." + month + "." + year + " " + time + " - " + message + " <button onclick=\"deleteMessage('" + messageId + "')\">Smazat</button> <button onclick=\"editMessage('" + messageId + "')\">Upravit</button></p>";
...
function editMessage(messageId) {
    ...
    var newText = prompt("Upravit zprávu:", messageText);
    if (newText !== null) {
